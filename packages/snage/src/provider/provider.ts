...
export function requireArgument(field: RawProvidedField, argument: string, argumentType: 'string'): E.Either<string, string>;
export function requireArgument(field: RawProvidedField, argument: string, argumentType: 'number'): E.Either<string, number>;
export function requireArgument(field: RawProvidedField, argument: string, argumentType: 'boolean'): E.Either<string, boolean>;
export function requireArgument(field: RawProvidedField, argument: string, argumentType: 'string' | 'number' | 'boolean'): E.Either<string, unknown> {
    ...
    if (typeof field.provided.arguments[argument] !== argumentType) {
        return E.left(`wrong argument '${argument}': expected ${argumentType}, got ${typeof field.provided.arguments[argument]}`);
    }
